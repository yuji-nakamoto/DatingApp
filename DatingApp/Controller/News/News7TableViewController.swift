//
//  News7TableViewController.swift
//  DatingApp
//
...
class News7TableViewController: UIViewController, XMLParserDelegate {
    ...
    private func setupParser() {
        ...
        let urlString = "https://news.yahoo.co.jp/rss/topics/world.xml"
...
extension News7TableViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
extension News7TableViewController: UITableViewDelegate, UITableViewDataSource {
