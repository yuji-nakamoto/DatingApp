...
class News2TableViewController: UIViewController, XMLParserDelegate {
    ...
    private func setupParser() {
        ...
        let urlString = "https://news.yahoo.co.jp/rss/topics/entertainment.xml"
...
extension News2TableViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
