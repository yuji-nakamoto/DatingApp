//
//  News9TableViewController.swift
//  DatingApp
//
...
class News9TableViewController: UIViewController, XMLParserDelegate {
    ...
    private func setupParser() {
        ...
        let urlString = "https://news.yahoo.co.jp/rss/topics/local.xml"
...
extension News9TableViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
extension News9TableViewController: UITableViewDelegate, UITableViewDataSource {
