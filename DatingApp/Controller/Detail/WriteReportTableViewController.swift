//
//  WriteReportTableViewController.swift
//  DatingApp
//
...
class WriteReportTableViewController: UITableViewController, UITextViewDelegate {
    ...
    private func setupUI() {
        ...
        if UserDefaults.standard.object(forKey: PINK) != nil {
            ...
            saveButton.setTitleColor(UIColor(named: O_BLACK), for: .normal)
            saveButton.layer.borderColor = UIColor(named: O_BLACK)?.cgColor
