...
protocol PickerKeyboard8Delegate: class {
...
class PickerKeyboard8: UIControl {
    
    weak var delegate: PickerKeyboard8Delegate?
    ...
    @objc private func tappedPickerKeyboard(_ sender: PickerKeyboard8) {
...
extension PickerKeyboard8: UIPickerViewDelegate, UIPickerViewDataSource {
