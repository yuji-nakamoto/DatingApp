...
protocol PickerKeyboard13Delegate: class {
...
class PickerKeyboard13: UIControl {
    
    weak var delegate: PickerKeyboard13Delegate?
    ...
    @objc private func tappedPickerKeyboard(_ sender: PickerKeyboard13) {
...
extension PickerKeyboard13: UIPickerViewDelegate, UIPickerViewDataSource {
