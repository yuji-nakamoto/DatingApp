...
protocol PickerKeyboard9Delegate: class {
...
class PickerKeyboard9: UIControl {
    
    weak var delegate: PickerKeyboard9Delegate?
    ...
    @objc private func tappedPickerKeyboard(_ sender: PickerKeyboard9) {
...
extension PickerKeyboard9: UIPickerViewDelegate, UIPickerViewDataSource {
