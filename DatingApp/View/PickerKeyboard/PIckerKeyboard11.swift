...
protocol PickerKeyboard11Delegate: class {
...
class PickerKeyboard11: UIControl {
    
    weak var delegate: PickerKeyboard11Delegate?
    ...
    @objc private func tappedPickerKeyboard(_ sender: PickerKeyboard11) {
...
extension PickerKeyboard11: UIPickerViewDelegate, UIPickerViewDataSource {
