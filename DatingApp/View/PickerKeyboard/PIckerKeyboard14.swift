...
protocol PickerKeyboard14Delegate: class {
...
class PickerKeyboard14: UIControl {
    
    weak var delegate: PickerKeyboard14Delegate?
    ...
    @objc private func tappedPickerKeyboard(_ sender: PickerKeyboard14) {
...
extension PickerKeyboard14: UIPickerViewDelegate, UIPickerViewDataSource {
