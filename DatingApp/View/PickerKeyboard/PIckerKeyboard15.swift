...
protocol PickerKeyboard15Delegate: class {
...
class PickerKeyboard15: UIControl {
    
    weak var delegate: PickerKeyboard15Delegate?
    ...
    @objc private func tappedPickerKeyboard(_ sender: PickerKeyboard15) {
...
extension PickerKeyboard15: UIPickerViewDelegate, UIPickerViewDataSource {
