...
protocol PickerKeyboard10Delegate: class {
...
class PickerKeyboard10: UIControl {
    
    weak var delegate: PickerKeyboard10Delegate?
    ...
    @objc private func tappedPickerKeyboard(_ sender: PickerKeyboard10) {
...
extension PickerKeyboard10: UIPickerViewDelegate, UIPickerViewDataSource {
