...
protocol PickerKeyboard17Delegate: class {
...
class PickerKeyboard17: UIControl {
    
    weak var delegate: PickerKeyboard17Delegate?
    ...
    @objc private func tappedPickerKeyboard(_ sender: PickerKeyboard17) {
...
extension PickerKeyboard17: UIPickerViewDelegate, UIPickerViewDataSource {
