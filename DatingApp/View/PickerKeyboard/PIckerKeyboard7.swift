...
protocol PickerKeyboard7Delegate: class {
...
class PickerKeyboard7: UIControl {
    
    weak var delegate: PickerKeyboard7Delegate?
    ...
    @objc private func tappedPickerKeyboard(_ sender: PickerKeyboard7) {
...
extension PickerKeyboard7: UIPickerViewDelegate, UIPickerViewDataSource {
