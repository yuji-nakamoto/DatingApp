...
protocol PickerKeyboard12Delegate: class {
...
class PickerKeyboard12: UIControl {
    
    weak var delegate: PickerKeyboard12Delegate?
    ...
    @objc private func tappedPickerKeyboard(_ sender: PickerKeyboard12) {
...
extension PickerKeyboard12: UIPickerViewDelegate, UIPickerViewDataSource {
