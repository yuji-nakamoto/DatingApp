...
protocol PickerKeyboard16Delegate: class {
...
class PickerKeyboard16: UIControl {
    
    weak var delegate: PickerKeyboard16Delegate?
    ...
    @objc private func tappedPickerKeyboard(_ sender: PickerKeyboard16) {
...
extension PickerKeyboard16: UIPickerViewDelegate, UIPickerViewDataSource {
