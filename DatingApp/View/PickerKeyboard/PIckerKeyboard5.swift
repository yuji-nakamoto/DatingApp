...
protocol PickerKeyboard5Delegate: class {
...
class PickerKeyboard5: UIControl {
    
    weak var delegate: PickerKeyboard5Delegate?
    ...
    @objc private func tappedPickerKeyboard(_ sender: PickerKeyboard5) {
...
extension PickerKeyboard5: UIPickerViewDelegate, UIPickerViewDataSource {
