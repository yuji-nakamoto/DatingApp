...
protocol PickerKeyboard3Delegate: class {
...
class PickerKeyboard3: UIControl {
    ...
    weak var delegate: PickerKeyboard3Delegate?
    var array: Array<String> {
        return delegate!.titlesOfPickerViewKeyboard3(self)
    }
    ...
    @objc private func tappedPickerKeyboard(_ sender: PickerKeyboard3) {
...
extension PickerKeyboard3: UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    public func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        delegate?.didDone3(self, selectData: array[pickerView.selectedRow(inComponent: 0)])
    }
}
