...
protocol PickerKeyboard4Delegate: class {
...
class PickerKeyboard4: UIControl {
    ...
    weak var delegate: PickerKeyboard4Delegate?
    var array: Array<String> {
        return delegate!.titlesOfPickerViewKeyboard4(self)
    }
    ...
    @objc private func tappedPickerKeyboard(_ sender: PickerKeyboard4) {
...
extension PickerKeyboard4: UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    public func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        delegate?.didDone4(self, selectData: array[pickerView.selectedRow(inComponent: 0)])
    }
}
